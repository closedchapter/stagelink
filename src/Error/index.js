    ...
    return (
        <div id="home" className='animate__animated animate__fadeIn h-screen bg-black grid grid-rows-2 justify-items-center text-white text-center relative'>
            <div className='flex relative z-20 p-5'>
                <div className='my-auto text-4xl md:text-5xl lg:text-7xl font-black bg-black bg-opacity-40 rounded-lg p-2'><div className='inline-block text-red-500'>404</div> There has been an error</div>
            </div>
            <div className='flex relative z-20'>
                <div className='mb-auto bg-black bg-opacity-40 rounded-xl p-5'>
                    <Link to='/' className='flex justify-center align-center items-center py-3 px-6 select-none text-black text-lg font-semibold rounded-sm bg-white hover:bg-gray-400 active:text-white active:bg-gray-800'>

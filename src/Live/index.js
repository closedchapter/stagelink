...
const Landing = () => {
    return (
        <div className='bg-black flex h-screen'>
            ...
            <video className='animate__animated animate__fadeIn animate__slower animate__delay-1s absolute h-full object-cover z-0' playsInline loop autoPlay={true} allow="autplay" muted={true}>

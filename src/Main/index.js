        ...
        <div id="purpose" className='bg-black text-white p-7 pt-0 text-center relative z-20'>
            ...
            <div className='flex flex-col mb-20 container mx-auto md:w-1/2 text-white text-opacity-90 font-normal'>
                ...
                <div className='mt-12 flex-1'>
                    ...
                    <div className='text-base text-normal mt-5 leading-relaxed'>Our goal is to decentralise the sports entertainment industry by implementing cryptocurrency into the pay-per-view system. StageLink will also be hosting professional/influencer boxing events matches that can be enjoyed by fans from all over the world.</div>
                </div>
            </div>
            ...
            <div className='text-lg font-extrabold text-center md:text-left'>Out with the <div className='inline-block text-blue-500'>OLD</div> and in with the <div className='inline-block text-blue-500'>NEW</div></div>
                <div className='flex flex-col md:flex-row md:space-x-20'> 
                    <div className='box flex-1 mt-8 bg-black bg-opacity-40 p-5 rounded-lg'>Currently Pay-Per-View events can only be purchased through fiat which will be made more redundant as crypto becomes more prominent, however StageLink offers the cryptocurrency payment option aswell as fiat.</div>
                    <div className='box flex-1 mt-8 bg-black bg-opacity-40 p-5 rounded-lg'>Pay-Per-View events are bought for entertainment purposes, however, often the fights can be underwhelming and leave a sour taste when matches are quickly concluded. At StageLink we will provide other benefits so the customer is always left happy.</div>
                ...
                <div className='flex flex-col md:flex-row md:space-x-20'> 
                    <div className='box flex-1 mt-8 bg-black bg-opacity-40 p-5 rounded-lg'>Currently Pay-Per-View events are over-priced due to the monopolisation of the industry, we will charge fairer prices so that the common working man can afford to see these fights as we understand many people aspire to be able to watch these fights live at least once in their life.</div>

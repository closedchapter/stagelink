            ...
            <div className='mb-10 overflow-hidden'>
                ...
                <div className='font-bold text-2xl text-center leading-snug opacity-60 md:text-3xl md:mb-7'>StageLink <div>Ecosystem</div></div>
                    <div className='space-y-1'>
                        <div className='font-medium text-sm leading-0 opacity-50 lg:text-lg hidden'></div>
                        <div className='font-extrabold text-2xl leading-0 opacity-90 lg:text-4xl'>6%</div>
